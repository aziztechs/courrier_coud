...
require_once('../../traitement/courriers/traitement_ajout_courrier.php');
    ...
    <div class="container-fluid py-4">
        <div class="form-container">
            <div class="form-header">
                <h1 class="text-primary"><i class="fas fa-plus-circle me-2"></i>NOUVEAU COURRIER</h1>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="liste_courriers.php" class="btn btn-primary">
