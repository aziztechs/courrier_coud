            ...
            <div class="form-section">
                ...
                <form method="POST" id="myForm" action="../../traitement/fonctionCour.php" enctype="multipart/form-data">
                    <div class="row">
                        <!-- Première ligne -->
                        <div class="col-md-6">
                            <input style="height: 40px; border-radius: 20px" type="text" name="numero" id="numero" class="form-control" placeholder="Numéro du courrier" value="<?= htmlspecialchars($courrier['Numero_Courrier']); ?>" required>
                        </div>
                        ...
                        <!-- Deuxième ligne -->
                        <div class="col-md-6 mt-2">
                            <input type="text" name="objet" required class="form-control" placeholder="Objet du courrier" value="<?= htmlspecialchars($courrier['Objet']); ?>" required>
                        </div>
                        <div class="col-md-6 mt-2">
                            <input type="file" name="pdf" id="pdf" accept=".pdf" required class="form-control" value="<?= htmlspecialchars($courrier['pdf']); ?>">
                        </div>
