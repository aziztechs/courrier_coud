...
require_once('../../traitement/courriercsa/traitement_liste_courriercsa.php');
        ...
        <div class="card">
            <div class="card-header bg-primary d-flex justify-content-between align-items-center text-white">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="ajouter_courriercsa.php" class="btn btn-sm btn-light text-primary">
            ...
            <div class="card-body">
                ...
                <div class="filter-card mb-4">
                    <form method="get" action="liste_courrierscsa.php">
                            ...
                            <?php else: ?>
                                <?php foreach ($courriers as $courrier): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="view_courriercsa.php?id=<?= $courrier['id_courrier'] ?>" class="btn btn-sm btn-primary">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                        </td>
                                        <td class="table-actions text-center">
                                            <!-- Bouton Modifier - Désactivé si le courrier a un suivi -->
                                            <a href="modifier_courriercsa.php?id=<?= $courrier['id_courrier'] ?>" 
                                            ...
                                            <?php else: ?>
                                                <a href="../suiviscourcsa/ajouter_suivi_courriercsa.php?courrier_id=<?= $courrier['id_courrier'] ?>" 
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    confirmDeleteBtn.href = `liste_courrierscsa.php?action=supprimer&id=${courrierId}`;
                    deleteModal.show();
                });
            });
...
function buildPaginationLink($page, $queryParams) {
    ...
    return 'liste_courrierscsa.php?' . http_build_query($queryParams);
}
?>