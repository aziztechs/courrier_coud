...
if (!isset($_GET['id']) || !is_numeric($_GET['id'])) {
    header('Location: dashboard_csa.php');
    exit();
}
...
$query = "SELECT * FROM courriercsa WHERE id_courrier = ?";
...
if (!$courrier) {
    header('Location: dashboard_csa.php?error=courrier_not_found');
    exit();
}
        ...
        <div class="row justify-content-center">
            <main class="col-lg-10 col-xl-8">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <a href="../dashboards/dashboard_csa.php" class="btn action-btn back-btn">
