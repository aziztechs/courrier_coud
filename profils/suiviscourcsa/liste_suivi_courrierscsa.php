        ...
        <div class="card">
            <div class="card-header bg-primary d-flex justify-content-between align-items-center text-white">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="../courrierscsa/liste_courrierscsa.php" class="btn btn-light">
                    ...
                    <form method="GET" class="row g-2 align-items-end">
                        <div class="filter-row mb-3">
                            ...
                            <div class="col-md-1 d-flex align-items-end">
                                ...
                                <a href="liste_suivi_courrierscsa.php" class="btn btn-outline-secondary">
                                ...
                                <?php foreach ($suivis as $suivi): ?>
                                    <tr>
                                        ...
                                        <td class="text-nowrap text-center">
                                            <a href="modifier_suivi_courriercsa.php?id=<?= $suivi['id_suivi'] ?>" 
        ...
        btn.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `supprimer_suivi_courriercsa.php?id=${id}`;
                }
            });
        });
    });
