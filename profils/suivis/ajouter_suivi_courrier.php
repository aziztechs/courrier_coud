...
$courrier_info = [];
if ($courrier_id) {
    $query = "SELECT id_courrier, Numero_Courrier, date, Objet, Expediteur FROM courrier WHERE id_courrier = ?";
                        ...
                        <form id="suiviForm" method="POST" novalidate>
                            <div class="row g-3">
                                ...
                                <div class="col-12 mt-4">
                                    ...
                                    <a href="liste_suivi_courriers.php" class="btn btn-secondary">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if (isset($_SESSION['show_success_modal']) && $_SESSION['show_success_modal']): ?>
                Swal.fire({
                    ...
                    willClose: () => {
                        window.location.href = 'liste_suivi_courriers.php';
                    }
                });
