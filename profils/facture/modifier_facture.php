...
require_once('../../traitement/factures/traitement_modif_facture.php');
...
<head>
   <meta charset="UTF-8">
    ...
    <title>COUD - Modifier une Facture</title>
...
<body>
    ...
    <div class="info-banner text-white d-flex justify-content-center align-items-center"
        ...
        <div class="user-info-section">
            <p class="lead">Espace Administration : Modification de Facture<br>
                <span>
    ...
    <div class="container_fluid mt-4">
        <div class="card form-container">
            <div class="card-header bg-primary text-white">
                <h2 class="h4"><i class="bi bi-pencil-square"></i> Modifier Facture #<?= $id_facture ?></h2>
            </div>
            
            <div class="card-body">
                <?php if (isset($show_redirect_message)): ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <i class="bi bi-check-circle-fill"></i> La facture a été modifiée avec succès. Redirection vers la liste dans 2 secondes...
                ...
                <form method="post" enctype="multipart/form-data" novalidate>
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <label for="facture_pdf" class="form-label">Nouveau fichier PDF</label>
                            ...
                            <?php endif; ?>
                            <div class="form-text">Taille maximale : 5MB - Laisser vide pour conserver le fichier actuel</div>
                        </div>
                        ...
                        <div class="col-12 mt-4">
                            ...
                            <button type="button" class="btn btn-outline-danger float-end" 
                                    onclick="if(confirm('Êtes-vous sûr de vouloir supprimer cette facture ?')) { 
                                        window.location.href='supprimer_facture.php?id=<?= $id_facture ?>'; 
                                    }">
    ...
    <!-- [Scripts identiques à ajouter_facture.php] -->
