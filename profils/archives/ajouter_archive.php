...
require_once('../../traitement/archive/traitement_ajouter_archive.php');
?>
            ...
            <div class="col-lg-10">
                <div class="form-container">
                    <div class="form-header">
                        <h2 class="h4 mb-0"><i class="bi bi-archive me-2"></i>Nouvelle Archive</h2>
                    </div>
                    ...
                    <form method="post" enctype="multipart/form-data" class="needs-validation" novalidate id="archiveForm">
                        <div class="row g-3">
                            ...
                            <!-- Fichier PDF -->
                            <div class="col-12">
                                <label class="form-label required-field">Document PDF</label>
                                <div class="file-upload-container" onclick="document.getElementById('pdf_archive').click()">
                                    ...
                                    <p class="mb-3" id="fileLabel">Glissez-déposez ou cliquez pour sélectionner</p>
                                    ...
                                    <div class="invalid-feedback">
                                        Sélectionnez un fichier PDF valide.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="commentaire" name="commentaire" 
                                          rows="4" placeholder="Description ou notes supplémentaires..."></textarea>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Voulez-vous vraiment enregistrer cette archive ?</p>
